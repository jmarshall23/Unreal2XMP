...
public:
	...
	virtual INT LockDynamicStream(FVertexStream* Stream,BYTE** VertexBufferContents) { return 0; }
	virtual void UnlockDynamicStream(FVertexStream* Stream) {}
	virtual INT LockDynamicIndexBuffer(FIndexBuffer* IndexBuffer,BYTE** IndexBufferContents) { return 0; }
