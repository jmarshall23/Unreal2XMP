...
class ENGINE_API UViewport : public UPlayer
{
	...
	UBOOL           bShowCollision;    // Draw the collision cylinders for meshes and sprites that collide with actors.
...
class ENGINE_API UClient : public UObject
{
	...
	BITFIELD	ScreenFlashes:1;
	BITFIELD	NoLighting:1;
	BITFIELD	Decals:1;
	BITFIELD	NoDynamicLights:1;
	BITFIELD    NoFractalAnim:1;
	BITFIELD	Coronas:1;
	BITFIELD	DecoLayers:1;
	BITFIELD	Projectors:1;
	BITFIELD	PlayerShadows:1;
	BITFIELD	ReportDynamicUploads:1;
	INT			WindowedViewportX GCC_PACK(4);
	INT			WindowedViewportY;
	INT			WindowedOffsetX; //NEW (mdf) windowed mode offset support
	INT			WindowedOffsetY; //NEW (mdf) windowed mode offset support
