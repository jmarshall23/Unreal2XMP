...
#define HUMANRADIUS     36 //normal player pawn radius
#define HUMANHEIGHT     78 //normal playerpawn height
#define CROUCHEDHUMANHEIGHT  43 //crouched playerpawn height
#define MAXPATHDIST		1200 // maximum distance for paths between two nodes
#define MAXPATHDISTSQ	MAXPATHDIST*MAXPATHDIST
#define TESTJUMPZ		420	// jumpz for defining paths (based on player jumpz for your game)
#define TESTGROUNDSPEED 600	// groundspeed for defining paths (based on player groundspeed for your game)
...
#define MAXJUMPHEIGHT	96.f // max height of ledge pawn can jump up onto
