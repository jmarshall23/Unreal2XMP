...
var() bool bNotBased;			//NEW (mdf): made editable - used by path builder - if true, no error reported if node doesn't have a valid base
//OLD var	const bool	bNotBased;		// used by path builder - if true, no error reported if node doesn't have a valid base
