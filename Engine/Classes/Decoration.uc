...
event TakeDamage( int NDamage, Pawn InstigatedBy, vector Hitlocation, vector Momentum, class<DamageType> DamageType)
{
	...
	{
		//NOTE: This can cause actors to fall through terrain
