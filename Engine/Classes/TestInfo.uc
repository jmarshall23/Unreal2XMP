...
//NEW (mdf) test additional directives support (code ignored unless -debug used with ucc make)
	#debug log( "log on debug line" );

	#debug
	log( "log after debug line" );

	#debugbegin
	log( "log between debugbegin and debugend #1: " $ default.bHidden );
	log( "log between debugbegin and debugend #2: " $ default.bHidden );
	#debugend
	...
	*/
	...
	#debugbegin
		#if0
		// skip directives inside #debugbegin..#debugend
		#endif0
	#debugend

	#debugbegin
		#debugbegin
			//nested #debugbegin..debugend
		#debugend
	#debugend
	...
	*/
	#endif0
	#if0
		// skip directives inside #if0..#endif0
		#debug foo
		#debugbegin
		#debugend
		garbage
