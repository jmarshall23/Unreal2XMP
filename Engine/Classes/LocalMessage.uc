...
var string MessageLabel;
var sound MessageSound;
var font MessageFont;
var int MessageWrapX;
...
{
	class'Console'.static.ShowStatusMessage( P, GetString(Switch,RelatedPRI_1,RelatedPRI_2,OptionalObject), Default.Lifetime, Default.MessageFont, GetColor(Switch,RelatedPRI_1,RelatedPRI_2), Default.MessageSound,,, Default.MessageHolder, Default.MessageLabel,, Default.MessageWrapX );
/*!!MERGE
	if ( P.myHud != None )
