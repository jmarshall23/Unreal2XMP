...
#exec Font Import File=Textures\SmallFont.bmp Name="DefaultFont" MIPS=Off
...
var font DebugFont;			 //NEW (mdf) console debugging font
...
native final function vector Project( vector V, optional vector CameraLocation, optional rotator CameraRotation );
...
defaultproperties
{
	...
	//!!MERGE TinyFontName="WarfareFonts.FontMono"
	//!!MERGE SmallFontName="WarfareFonts.FontMono"
	//!!MERGE MedFontName="WarfareFonts.FontMono800x600"
	//!!MERGE DebugFont=Font'Engine.DebugFont'
