...
class EDITOR_API UEditorEngine : public UEngine
{
	...
	UBOOL Exec_Shader( const TCHAR* Str, FOutputDevice& Ar );
	...
	virtual void SetPivot( FVector NewPivot, UBOOL SnapPivotToGrid, UBOOL MoveActors, UBOOL bIgnoreAxis ) {}
      virtual void SetPivot( FVector NewPivotLoc, FRotator NewPivotRot, UBOOL SnapPivotToGrid, UBOOL MoveActors, UBOOL bIgnoreAxis ) {} // Added by Demiurge (3DDragRot)
	...
	// Particle support.
	virtual void edactCreateNewParticleSystem( ULevel* Level, AActor* Image );
	virtual void edactConformParticleSystems( ULevel* Level, AActor* Image );
	virtual void edactCleanParticleSystems( ULevel* Level );
