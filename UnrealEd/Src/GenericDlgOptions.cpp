...
void UOptionsNewTerrain::StaticConstructor()
{
	...
	Group = TEXT("Heightmaps");
	Name = TEXT("TerrainHeightmap");
	Height = 32768;
...
void UOptionsNewTerrainLayer::InitFields()
{
	...
	new(GetClass(),TEXT("AlphaFill"), RF_Public)UByteProperty(CPP_PROPERTY(AlphaFill), TEXT(""), CPF_Edit );
...
void UOptionsNewTerrainLayer::StaticConstructor()
{
	...
	VScale = 1;
	Package = TEXT("MyLevel");
	Group = TEXT("Alphamaps");
	Name = TEXT("AlphaLayer");
