...
class WDlgImportStaticMesh : public WDialog
{
	...
	void OnInitDialog()
	{
		...
		PackageEdit.SelectionEndOkDelegate = FDelegate(this, (TDelegate)&WDlgImportStaticMesh::RefreshGroupCombo);
		// End add by Demiurge
	...
	void OnCommand( INT Command )
	{
		...
		switch( Command )
		{
			...
			case IDMN_SM_IMPORT_ASE:
			{
				...
				ofn.lpstrFilter = "Supported formats (*.ase)\0*.ase\0ASE Files (*.ase)\0*.ase\0\0";
				ofn.nFilterIndex = 1;
				ofn.lpstrDefExt = "ase";
