...
class WDlgMapCheck : public WDialog
{
	...
	,	GotoActorButton		( this, IDPB_GOTOACTOR, FDelegate(this,(TDelegate)&WDlgMapCheck::OnItemListDblClk) )
	,	DeleteActorButton	( this, IDPB_DELETEACTOR, FDelegate(this,(TDelegate)&WDlgMapCheck::OnDeleteActor) )
	...
	void OnDeleteActor()
	{
		guard(WDlgMapCheck::OnDeleteActor);
