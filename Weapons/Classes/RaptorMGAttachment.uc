class RaptorMGAttachment extends U2WeaponAttachment;
...
simulated event ThirdPersonEffects()
{
    ...
    if (Level.NetMode == NM_Client && Instigator? && !(Instigator.IsLocallyControlled()))
	{
		...
		if (!MuzzleFire)
		{
			MuzzleFire = class'ParticleGenerator'.static.CreateNew( self, ParticleSalamander'Turret_Chaingun_FX.ParticleSalamander3', Location  );
		}
