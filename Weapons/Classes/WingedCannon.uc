...
class WingedCannon extends TurretWeapon;
...
simulated function PostBeginPlay()
{
	...
	Muzzledamage = class'ParticleGenerator'.static.CreateNew( self, ParticleSalamander'Turret_Winged_FX.ParticleSalamander3', Location  );
...
defaultproperties
{
	...
	AttachmentClass=class'WingedCannonAttachment'
	PlayerViewOffset=(X=20,Y=4,Z=-32)
	FireOffset=(X=42.0,Y=9.0,Z=-34.0)

	AmmoName(0)=class'WingedCannonAmmo'
