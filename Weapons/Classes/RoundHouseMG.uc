...
class RoundHouseMG extends TurretWeapon;

#exec OBJ LOAD File=..\Particles\Turret_Roundhouse_FX.u
...
simulated function PostBeginPlay()
{
	...
	{
		Muzzle1flash = class'ParticleGenerator'.static.CreateNew( self, ParticleSalamander'Turret_Roundhouse_FX.ParticleSalamander0', Location  );
		Muzzle1flash.SetBase(Instigator);
		Muzzle2flash = class'ParticleGenerator'.static.CreateNew( self, ParticleSalamander'Turret_Roundhouse_FX.ParticleSalamander0', Location  );
		Muzzle2flash.SetBase(Instigator);
	}
	Muzzle1damage = class'ParticleGenerator'.static.CreateNew( self, ParticleSalamander'Turret_Roundhouse_FX.ParticleSalamander3', Location  );
	Muzzle1damage.SetBase(Instigator);
	Muzzle2damage = class'ParticleGenerator'.static.CreateNew( self, ParticleSalamander'Turret_Roundhouse_FX.ParticleSalamander3', Location  );
...
defaultproperties
{
	...
	AttachmentClass=class'RoundHouseMGAttachment'
	PlayerViewOffset=(X=20,Y=4,Z=-32)
	FireOffset=(X=42.0,Y=9.0,Z=-34.0)

	AmmoName(0)=class'RoundHouseMGAmmo'
