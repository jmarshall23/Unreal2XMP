...
public:
	...
	void SetVertexShaderConstants(FPlane ConstantArray[]);
	void SetPixelShaderConstants(FPlane ConstantArray[]);
...
protected:
	struct FD3DInternalState
	{
		...
		FPlane*						VertexShaderConstants;
		FPlane*						PixelShaderConstants;
