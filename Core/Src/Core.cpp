...
CORE_API TCHAR					GCrashLogFilename[1024]=TEXT("");	/* For copying the log to a file server after a crash */
...
CORE_API QWORD					GStartCycles=0;					/* CPU cycle count at game initialization */	//NEW (arl)
...
CORE_API UBOOL					GIsPixomatic = 0;
CORE_API ERunningOS				GRunningOS = OS_UNKNOWN;

CORE_API DWORD					GMemoryTag			= 0;
CORE_API DWORD					GAllocatedMemory	= 0;
