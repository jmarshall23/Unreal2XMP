...
UObjectNativeInfo GCoreUObjectNatives[] =
{
	...
	MAP_NATIVE( UObject, execQuestion_Bool )
	//MAP_NATIVE( UObject, execNot_PreBool )
	MAP_NATIVE( UObject, execQuestion_Name )
	MAP_NATIVE( UObject, execNot_PreName )
	MAP_NATIVE( UObject, execQuestion_Int )
	MAP_NATIVE( UObject, execNot_PreInt )
	MAP_NATIVE( UObject, execQuestion_Float )
	MAP_NATIVE( UObject, execNot_PreFloat )
	MAP_NATIVE( UObject, execQuestion_Object )
	MAP_NATIVE( UObject, execNot_PreObject )
	MAP_NATIVE( UObject, execQuestion_Str )
	MAP_NATIVE( UObject, execNot_PreStr )
	MAP_NATIVE( UObject, execQuestion_Vector )
	MAP_NATIVE( UObject, execNot_PreVector )
	MAP_NATIVE( UObject, execQuestion_Rotator )
	MAP_NATIVE( UObject, execNot_PreRotator )
	...
	MAP_NATIVE( UObject, execStrArray )
	...
	MAP_NATIVE( UObject, execResetLoaders )
	MAP_NATIVE( UObject, execIsInState )
	MAP_NATIVE( UObject, execGetStateName )
	MAP_NATIVE( UObject, execAddTimer )
	MAP_NATIVE( UObject, execAddTimerS )
	MAP_NATIVE( UObject, execRemoveTimer )
	MAP_NATIVE( UObject, execRemoveTimerS )
	MAP_NATIVE( UObject, execTimeRemaining )
	MAP_NATIVE( UObject, execTimeRemainingS )
	...
	MAP_NATIVE( UObject, execRotateAngleAxis )
	{NULL, NULL}
};
