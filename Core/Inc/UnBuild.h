...
// Whether to enable unrealscript profiling support.
#ifndef USCRIPT_PROFILE
#define USCRIPT_PROFILE 1
#endif

// Whether to use Mike Lambert's new network code.
#ifndef NEWNET
#define NEWNET 0
#endif

// Whether to use Demiurge's hardware shader code.
#ifndef DS_SHADER
#define DS_SHADER 1
#endif
