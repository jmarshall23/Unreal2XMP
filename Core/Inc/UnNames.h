...
REG_NAME_HIGH( 732, OrderedArray)
REG_NAME_HIGH( 733, Map)
...
REGISTER_NAME( 796, DevSpam)	//NEW (mdf) logging
...
REGISTER_NAME( 841, ToAll)
REGISTER_NAME( 842, DOREP)
REGISTER_NAME( 843, FORCEREP)
...
// AI.
#if 1 //NEW (mdf)
REGISTER_NAME( 340, SeeEnemy         			) // Can see an enemy.
...
REGISTER_NAME( 344, SpecialHandling				) // Navigation point requests special handling.
REGISTER_NAME( 345, EnemyInvalid				) // Current enemy is invalid
REGISTER_NAME( 346, EnemyRangeTransition		) // Enemy moved within some threshold.
REGISTER_NAME( 347, Probe47			 			)
#else
...
//!!MERGE -- Reorganize probes so the following can be included.
REGISTER_NAME( 366, Constructed		) // Object was constructed.
