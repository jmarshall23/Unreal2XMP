...
enum EPropertyFlags
{
	...
	CPF_HasMinMax	 = 0x80000000, //NEW (MJL) Property has a min/max value, for network optimization
...
#define IMPLEMENT_PACKAGE_EX(pkg) \
	IMPLEMENT_PACKAGE(pkg) \
	extern "C" DLL_EXPORT void CDECL PackageInit()
...
private:
	...
	static UBOOL			GObjPurgingGarbage;	// Are we in the middle of collecting garbage?
	...
	static TArray<UObject*> PendingDeleteObjects;
...
public:
	...
	static FName GetEnum( UObject* E, BYTE Val );
	static FString EnumStr( UObject* Type, BYTE Val, INT Pre );
	static FName StringToName( const FString& S, UBOOL bAdd );

	// Boolean operators.
	virtual UBOOL IsLessThan( const UObject* A ) const { debugf( NAME_Warning, TEXT("UObject::IsLessThan not implemented.") ); return false; }
	...
	static UBOOL PurgingGarbage(){ return GObjPurgingGarbage; }
#ifndef __MWERKS__
	static UPackage* GetTransientPackage();
#endif
	...
	UBOOL IsA( const TCHAR* SomeBaseClassName ) const;
	...
	DECLARE_FUNCTION(execDivide_FloatRange)
	...
	DECLARE_FUNCTION(execQuestion_Bool)
	//DECLARE_FUNCTION(execNot_PreBool)
	DECLARE_FUNCTION(execQuestion_Name)
	DECLARE_FUNCTION(execNot_PreName)
	DECLARE_FUNCTION(execQuestion_Int)
	DECLARE_FUNCTION(execNot_PreInt)
	DECLARE_FUNCTION(execQuestion_Float)
	DECLARE_FUNCTION(execNot_PreFloat)
	DECLARE_FUNCTION(execQuestion_Object)
	DECLARE_FUNCTION(execNot_PreObject)
	DECLARE_FUNCTION(execQuestion_Str)
	DECLARE_FUNCTION(execNot_PreStr)
	DECLARE_FUNCTION(execQuestion_Vector)
	DECLARE_FUNCTION(execNot_PreVector)
	DECLARE_FUNCTION(execQuestion_Rotator)
	DECLARE_FUNCTION(execNot_PreRotator)
	...
	DECLARE_FUNCTION(execAblend)
	DECLARE_FUNCTION(execBlend_Range)
	DECLARE_FUNCTION(execAblend_Range)
	DECLARE_FUNCTION(execFDecision)
	DECLARE_FUNCTION(execProgressSeed)
	...
	DECLARE_FUNCTION(execAddTimerS)
	DECLARE_FUNCTION(execRemoveTimer)
	DECLARE_FUNCTION(execRemoveTimerS)
	DECLARE_FUNCTION(execRemoveAllTimers)
	DECLARE_FUNCTION(execTimeRemaining)
	DECLARE_FUNCTION(execTimeRemainingS)
	...
	void eventConstructed()
    {
        ProcessEvent(FindFunctionChecked(NAME_Constructed),NULL);
    }
};
